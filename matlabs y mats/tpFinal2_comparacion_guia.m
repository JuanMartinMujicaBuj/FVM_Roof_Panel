...
caseManager_comparacion_guia;
propiedades_materiales;
% Condiciones de borde y propiedades del problema de la guía, sin radiación
Tin = 22+273; %[K]
Tout = -5+273; % [K]
hin = 0.025*ones(totNelInLength,1); % [W/m2K]
hout = 0.25;  % [W/m2K]
k_yeso = 0.8; % [W/mK]
k_madera = 0.5; % [W/mK]
k_aislante = 0.035; % [W/mK]
k_metal = 1000; % [W/mK]
emisividad_metal = 0; % []
qrad = 0; % [W/m2]
...
%% Creación de las matrices A, A0 y B para resolver T(t) = A\(B-A0*T(t-1))
